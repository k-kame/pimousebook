...
はじめに開発用 PC をセットアップしますが，PC の OS が windows 10 ／ ubuntu のどちらかで，やらなければならない内容が異なります．
...
ここで，作業 2 と 3 は，win / ubuntu どちらの場合でも必要ですが，ubuntu の場合は作業 1 が不要となります．
個人的には，「windows 上で ubuntu」はとても快適ですが，構築に手間がかかるので，環境構築大好き民以外にはおススメできないかも．

一方で，ubuntu を選ぶと，Linux Desktop に住むという苦行（？）が待っているので，どちらがいいとは言えないかもしれません．

デュアルブート@<fn>{dualboot}という選択肢もありますが，それなりにトラブル対応できる能力が必要だと思いますし，windows をぶっ壊すとダメージが大きいです（結構トラブったりする）．

というわけで，PC を，普段使いの windows ／開発用 ubuntu の二台準備するという富豪的アプローチがベストではありますが，お金がかかります．
