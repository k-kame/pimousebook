...
本書は，これからロボット開発（ハードもソフトも）に関わる人は知っておくべき（と著者が勝手に思っている）ROS（Robot Operating System）について，@<b>{開発環境の構築}と@<b>{制御プログラム開発}が出来るようになることを目的として作られました．
...
さらに，このような開発で必要なスキルとしては，「行き詰ったら書籍やインターネットや調べる」という能力が必要ですし，自分が必要な情報と 100% 一致している情報が見つかるとは限りませんので（バージョンや環境 の違いなど），集めた情報を繋ぎ合わせ，自分の環境に適用するという能力も重要です．

よって，本冊子では，「既に説明されていることで参照が容易なものは，参 照先を示して記載を省く」という方針を取っています． 

ですので，上記書籍についてもポチって本棚にカッコよく飾っておきましょう．本冊子で手を動かし，悩んだり理解が進んだ時点で紐解くのが良いと思います． 
